...
static NSTimeInterval const kSZYViewShakerDefaultDuration = 0.5;
static NSString * const kSZYViewShakerAnimationKey = @"kSZYViewShakerAnimationKey";

@interface SZYViewShaker ()
@property (nonatomic, strong) NSArray * views;
@property (nonatomic, assign) NSUInteger completedAnimations;
@property (nonatomic, copy) void (^completionBlock)();
@end

@implementation SZYViewShaker
...
- (void)shake {
    [self shakeWithDuration:kSZYViewShakerDefaultDuration completion:nil];
}
...
- (void)addShakeAnimationForView:(UIView *)view withDuration:(NSTimeInterval)duration {
    ...
    [view.layer addAnimation:animation forKey:kSZYViewShakerAnimationKey];
}
